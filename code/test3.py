...
while True:
    ...
    for face_rect in detected_faces:
        ...
        # 얼굴 랜드마크 예측 및 임베딩 추출
        shape = face_pose_predictor(rgb_frame, face_rect)
        face_descriptor = face_descriptor_extractor.compute_face_descriptor(rgb_frame, shape)
       ...
       # 텍스트 크기 계산
        ...
        draw.rectangle(text_background, fill=(0, 255, 0, 128))
